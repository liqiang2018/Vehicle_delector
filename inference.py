...
if __name__ == '__main__':
    ...
    test_img_path = os.path.join(FLAGS.dataset_dir, FLAGS.test)
    ...
    with detection_graph.as_default():
        with tf.Session(graph=detection_graph) as sess:
            ...
            name, ext = os.path.splitext(FLAGS.test)
            filename = "".join((name+"_output", ext))
            #plt.imsave(os.path.join(FLAGS.output_dir, 'output.png'), image_np)
            plt.imsave(os.path.join(FLAGS.dataset_dir, filename), image_np)
